...
export const Overlay2 = ({ images }: any) => (
...
function Frame({ url, text, c = new THREE.Color(), ...props }: any) {
  ...
  return (
    <group {...props}>
      ...
      <Text maxWidth={0.25} anchorX="left" anchorY="top" position={[0.55, GOLDENRATIO, 0]} fontSize={0.035} color="black">
        {text}
      </Text>
    </group>
  )
